...
function InfoParqueadero() {
  ...
  const confirmarSeleccion = () => {
    const puestosGenerados: PuestoParqueo[] = [
      { id: 1, ocupado: false, imagen: 'URL_imagen_desocupado_1', tipoVehiculo: '', placa: '', ano: 0, tiempoReserva: 0 },
      { id: 2, ocupado: false, imagen: 'URL_imagen_desocupado_2', tipoVehiculo: '', placa: '', ano: 0, tiempoReserva: 0 },
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap' }}>
            {puestosParqueo.map((puesto) => (
              ...
              >
                <img src={puesto.imagen} alt={`Puesto ${puesto.id}`} />
                {puesto.ocupado ? (
                  <p>Puesto ocupado</p>
                ) : (
